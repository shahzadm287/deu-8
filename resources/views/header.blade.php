								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/custom/images/avatar/1.jpg') }}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/custom/images/avatar/2.jpg') }}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/custom/images/avatar/3.jpg') }}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/custom/images/avatar/4.jpg') }}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('assets/custom/images/avatar/5.jpg') }}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
						...
						<div class="card chat dlab-chat-history-box d-none">
							...
							<div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset('assets/custom/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('assets/custom/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
									</div>
									<div class="msg_cotainer">
				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="{{ asset('assets/custom/images/profile/pic1.jpg') }}" width="20" alt=""/>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{ url('/') }}">Dashboard Light</a></li>
							<li><a href="{{ url('/index-2') }}">Dashboard Dark</a></li>
							<li><a href="{{ url('/my-wallet') }}">My Wallet</a></li>
							<li><a href="{{ url('/page-invoices') }}">Invoices</a></li>
							<li><a href="{{ url('/page-transaction') }}">Transaction</a></li>
							<li><a href="{{ url('/transaction-details') }}">Transaction Details</a></li>	
						</ul>
