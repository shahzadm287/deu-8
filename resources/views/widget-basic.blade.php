@include("header");
                ...
                <div class="row">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card border-0 pb-0">
                            ...
                            <div class="card-body"> 
                                <div id="dlab_W_Todo2" class="widget-media dlab-scroll height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card border-0 pb-0">
                            ...
                            <div class="card-body"> 
                                <div id="dlab_W_Todo3" class="widget-media dlab-scroll height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card border-0 pb-0">
                            ...
                            <div class="card-body"> 
                                <div id="dlab_W_Todo4" class="widget-media dlab-scroll height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
					...
					<div class="col-xl-4 col-lg-6 col-sm-6">
                        <div class="card active_users">
                            <div class="card-header bg-secondary border-0 pb-0">
    ...
    ***********************************-->
	...
	<!-- Chartist -->
    <script src="{{ asset('assets/custom/vendor/chartist/js/chartist.min.js') }}"></script>
    <script src="{{ asset('assets/custom/vendor/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js') }}"></script>
    
	<!-- Flot -->
    <script src="{{ asset('assets/custom/vendor/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('assets/custom/vendor/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('assets/custom/vendor/flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('assets/custom/vendor/flot-spline/jquery.flot.spline.min.js') }}"></script>
	
	<!-- Chart sparkline plugin files -->
    <script src="{{ asset('assets/custom/vendor/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
	<script src="{{ asset('assets/custom/js/plugins-init/sparkline-init.js') }}"></script>
	
	<!-- Chart piety plugin files -->
    <script src="{{ asset('assets/custom/vendor/peity/jquery.peity.min.js') }}"></script>
	<script src="{{ asset('assets/custom/js/plugins-init/piety-init.js') }}"></script>
