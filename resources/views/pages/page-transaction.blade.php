								...
								<table class="table card-table display mb-4 dataTablesCard text-black" id="example5">
									...
									<tbody>
										<tr>
											...
											<td><a href="javascript:void(0)" class="btn btn-danger btn-rounded light">Canceled</a></td>
											<td>
										...
										<tr>
											...
											<td><a href="javascript:void(0)" class="btn btn-dark btn-rounded light">Pending</a></td>
											<td>
												<div class="dropdown dropstart">
													<a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<tr>
											...
											<td><span>Bangladesh,<br> India</span></td>
											<td><a href="javascript:void(0)" class="btn btn-success btn-rounded light">Completed</a></td>
											<td>
												<div class="dropdown dropstart">
													<a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
